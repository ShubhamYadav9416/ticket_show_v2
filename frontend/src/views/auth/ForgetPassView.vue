                    ...
                    <div class="inner-box">
                        ...
                        <div>
                            <form>
                                ...
                                <button type="button" class="form-control" id="submit" @click="forgetPasswordUser()">ReSet Password</button>
                            </form>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        forgetPasswordUser() {
            ...
            axios
                .post("http://127.0.0.1:8081/api/forget_pass", {
                ...
                .then((response) => {
                    ...
                    if (response.data.status === "failed"){
                        alert("User mail not found, Please register")
                        this.$router.push("/login");
                    }
                })
                .catch((error) => {
